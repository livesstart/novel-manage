...
EXPECTED_ROUTES = [
    ...
    ('/api/ai/novels/<int:novel_id>/reader-assistant', 'POST'),
    ('/api/ai/novels/<int:novel_id>/settings/analyze', 'POST'),
    ('/api/ai/novels/<int:novel_id>/writing-style/analyze', 'POST'),
    ...
    ('/api/novels/<int:novel_id>/settings', 'GET'),
    ('/api/novels/<int:novel_id>/writing-style', 'GET'),
