// Application event binding orchestration.
...
function bindNovelSearchEvents() {
    // 搜索
    let searchTimeout;
...
function bindCharacterLibraryEvents() {
...
function bindNovelFilterEvents() {
    // 筛选器
...
function bindNovelManagementEvents() {
    // 添加小说按钮
...
function bindEvents() {
    ...
    bindNovelSearchEvents();
    bindCharacterLibraryEvents();
